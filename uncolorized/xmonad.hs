...
-------------------------------------------------------------------------------
_PP = defaultPP { ppCurrent         = xmobarColor "$blue" "" . wrap "<" ">"
                , ppHidden          = xmobarColor "$byellow" ""
                , ppHiddenNoWindows = xmobarColor "$bg" ""
                , ppUrgent          = xmobarColor "$magenta" "" . wrap "[" "]"
                , ppSep             = xmobarColor "$byellow" "" " : "
                , ppSort            = fmap (.scratchpadFilterOutWorkspace) $ ppSort defaultPP
                , ppTitle           = xmobarColor "$byellow" "" . shorten 60
                , ppLayout          = xmobarColor "$byellow" ""
